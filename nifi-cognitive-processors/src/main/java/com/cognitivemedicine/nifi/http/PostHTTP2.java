...
@ReadsAttribute(attribute="mime.type", description="If not sending data as a FlowFile, the mime.type attribute will be used to set the HTTP Header for Content-Type. This is "
        + "a copy of PostHTTP that allows dynamic hosts in its URL property.")
public class PostHTTP2 extends AbstractProcessor {
    ...
    public static final PropertyDescriptor URL = new PropertyDescriptor.Builder()
            .name("URL")
            .description("The URL to POST to. In contrast with PostHTTP processor, the first part of the URL could not be static. For example, https://${hostname} is valid and https://1.1.1.1:8080/files/${nf.file.name} is also valid.")
            .required(true)
